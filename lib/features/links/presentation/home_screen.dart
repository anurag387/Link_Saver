                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                profile.displayName.isNotEmpty ? profile.displayName : 'Link Saver User',
                                style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold),
                              ),
                              const SizedBox(height: AppSpacing.micro),
                              Text(
                                profile.bio.isNotEmpty ? profile.bio : 'Your saved web, organized.',
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            icon: Icon(
                              ...
                              color: themeMode == ThemeMode.dark ? Colors.amber : theme.colorScheme.primary,
                            ),
                            onPressed: () {
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: profile.avatarBase64 != null && profile.avatarBase64!.isNotEmpty
                                  ? ClipOval(
                                      child: Image.memory(
                                        ...
                                        height: 42,
                                        fit: BoxFit.cover,
                                        errorBuilder: (_, __, ___) => Text(profile.avatarEmoji, style: const TextStyle(fontSize: 22)),
                                      ),
                                    )
